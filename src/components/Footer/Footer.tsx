                ...
                <div className="row footer__row">
                    ...
                    <div className="col l-1 l-o-6 c-12">
                        <div className="box-icon">
                            <FontAwesomeIcon icon={faYoutube} style={{ marginRight: 10, fontSize: '20px' }} />
                            <FontAwesomeIcon icon={faFacebook} style={{ marginRight: 10, fontSize: '20px' }} />
                            <FontAwesomeIcon icon={faLinkedin} style={{ marginRight: 10, fontSize: '20px' }} />
                        </div>
                    </div>
                </div>
            </div>
