            ...
            <div className="protect2">
                <div className="grid wide">
                    ...
                    <div className="row protect__row">
                        ...
                        <div className="col c-6">
                            <div className="protect__row-item right" onclick="document.getElementById('img__id2').src='../../../../assets/img/item1.PNG'">
                                <i className='bx bx-info-circle item-icon'></i>
                                <div className="item-title">다양한 파일형식</div>
                        ...
                        <div className="col c-6">
                            <div className="protect__row-item2" onclick="document.getElementById('img__id2').src='../../../../assets/img/item2.PNG'">
                        ...
                        <div className="col c-6">
                            <div className="protect__row-item2 right" onclick="document.getElementById('img__id2').src='../../../../assets/img/item3.PNG'" />
                        ...
                        <div className="col c-6">
                            <div className="protect__row-item2" onclick="document.getElementById('img__id2').src='../../../../assets/img/last.PNG'" />
