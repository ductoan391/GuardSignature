...
function Header() {
    return (
        <div>
            ...
            <label htmlFor="input__id" className="overplay"></label>

            <div className="header-mobile">
                <label htmlFor="input__id" className="burger">
            ...
            <ul className="header__menu-mobile">
                <label htmlFor="input__id" className="mobile-close"><i className="mobile-close-icon fas fa-times"></i></label>
