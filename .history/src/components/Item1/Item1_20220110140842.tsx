...
import item2 from '../../Assets/img/item1.png';
import item3 from '../../Assets/img/item1.png';
import item4 from '../../Assets/img/item1.png';
                ...
                <div className="grid wide item1">
                    <div className="row">
                        <div className="col l-6 m-6 c-12">
                            <img src="../../../../assets/img/item1.PNG" className="item1__img" />
                        </div>
                        <div className="col l-6 m-6 c-12">
                ...
                <div className="item2">
                    <div className="grid wide item2-wrap">
                        <div className="row">
                            ...
                            <div className="col l-6 m-6 c-12">
                                <img src="../../../../assets/img/item2.PNG" className="item1__img" />
                            </div>
                        </div>
                    </div>
                </div>
