...
import icon2 from '../../Assets/img/upload-icon-2.png';
import icon3 from '../../Assets/img/upload-icon-3.png';
import icon4 from '../../Assets/img/upload-icon-4.png';
                    ...
                    <div className="row contract__bottom">
                        <div className="col l-3 m-3 c-12">
                            <div className="contract__bottom-item">
                                <img src={contract} alt="" className="item-img" />
                        ...
                        <div className="col l-3 m-3 c-12">
                            <div className="contract__bottom-item">
                                <img src={icon3} alt="" className="item-img" />
                                <div className="item-text">
                                    <div className="text-title">업로드하기</div>
                                    <div className="text-des">필요한 계약서 파일을
                                        업로드합니다.</div>
                        ...
                        <div className="col l-3 m-3 c-12">
                            <div className="contract__bottom-item item-img4">
                                <img src={icon4} alt="" className="item-img" />
                                <div className="item-text">
                                    <div className="text-title">업로드하기</div>
                                    <div className="text-des">필요한 계약서 파일을
                                        업로드합니다.</div>
